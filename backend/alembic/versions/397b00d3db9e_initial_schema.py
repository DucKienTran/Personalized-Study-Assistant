...
Revision ID: 397b00d3db9e
Revises: 
Create Date: 2026-07-30 03:57:13.558656
...
def upgrade() -> None:
    ...
    op.create_table('notebook_documents',
    sa.Column('id', mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_notebook_documents_id'), 'notebook_documents', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_notebook_summaries_id'), 'notebook_summaries', ['id'], unique=False)
    ...
    sa.Column('target_total_points', sa.Integer(), server_default='100', nullable=False),
    sa.Column('generation_mode', sa.String(length=20), server_default='simple', nullable=False),
    sa.Column('difficulty', sa.String(length=20), nullable=True),
    sa.Column('custom_instruction', sa.Text(), nullable=True),
    sa.Column('error_message', sa.Text(), nullable=True),
    sa.Column('time_limit_minutes', sa.Integer(), nullable=True),
    sa.Column('generation_status', sa.String(length=20), server_default='processing', nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['documents.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
