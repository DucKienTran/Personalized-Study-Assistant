...
class AIConfigurationError(InternalServerError):
    ...
    def __init__(
        self,
        message: str = "Cấu hình AI chưa hợp lệ. Vui lòng kiểm tra lại hệ thống."
    ):
...
class LLMGenerationError(InternalServerError):
    ...
    def __init__(
        self,
        message: str = "Không thể sinh nội dung từ AI."
    ):
        super().__init__(message)
...
class EmptyLLMResponseError(InternalServerError):
    ...
    def __init__(
        self,
        message: str = "AI không trả về nội dung hợp lệ."
    ):
        super().__init__(message)