...
export default function ConfirmButton({
    ...
    return (
        <button
            ...
            disabled={disabled}
            onClick={handleClick}
            className={`px-4 py-2 rounded-xl text-xs font-bold shadow-xs transition-all duration-150 transform active:scale-95 disabled:opacity-50 disabled:pointer-events-none cursor-pointer ${
